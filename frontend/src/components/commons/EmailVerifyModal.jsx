...
export default function Modal () {
  ...
  const {modalOpen, toggleModal} = ModalContext()
  ...
  return (
    <div className={`fixed z-50 inset-0 overflow-y-auto transition ${modalOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}>
