...
import { Link, Outlet } from "next/navigation";
...
const Sidebar = ({children}) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-no-wrap h-[calc(100vh-80px)]">
                  ...
                  <div className="-mt-5" onClick={() => setShow(!show)}>
                    {show ? (
                      <button
                        ...
                        id="close"
                        className="w-6 h-6 right-0 -mr-7 bg-blue-500 absolute shadow rounded-full flex items-center justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600"
                      >
                        <svg
                          width={16}
                          height={16}
                  ...
                  {show && (
                    <ul className="w-full mt-10">
                      <li className="text-base leading-4 pl-3 cursor-pointer text-gray-400">
                        <Link href="/admin/default">Dashboard</Link>
                      </li>
        ...
        <div className="w-full bg-blue-100 overflow-y-scroll">
          {children}
        </div>
      </div>
    </>
